...
<body class="antialiased">
    ...
    <div id="main">
            ...
            <div class="row">
                    ...
                    <div class="slidebar">
                        <ul class="slidebar__list">
                            ...
                            <li class="slidebar__item">
                                <a href="#iPhone" class="slidebar__item__link">
                            ...
                            <!-- laptop -->
                            <li class="slidebar__item">
                                <a href="#mac" class="slidebar__item__link">
                                    <div class="slidebar__item__link__text__wrapper">
                                        <div class="slidebar__item__link__text__wrapper__icon__box">
                            ...
                            <!-- tablet -->
                            <li class="slidebar__item">
                                <a href="#ipad" class="slidebar__item__link">
                                    <div class="slidebar__item__link__text__wrapper">
                                        <div class="slidebar__item__link__text__wrapper__icon__box">
                                            <i class="tablet-icon icon"></i>
                                        </div>
                                        <p>iPad</p>
                                    </div>
                                    <!-- <div class="slidebar__item__link__icon__last__wrapper">
                            ...
                            <!-- watch -->
                            <li class="slidebar__item">
                                <a href="#watch" class="slidebar__item__link">
                                    <div class="slidebar__item__link__text__wrapper">
                                        <div class="slidebar__item__link__text__wrapper__icon__box">
                                            <i class="watch-icon icon"></i>
                                        </div>
                                        <p>Watch</p>
                                    </div>
                                    <!-- <div class="slidebar__item__link__icon__last__wrapper">
                            ...
                            <!-- monitor -->
                            <li class="slidebar__item">
                                <a href="#imac" class="slidebar__item__link">
                                    <div class="slidebar__item__link__text__wrapper">
                                        <div class="slidebar__item__link__text__wrapper__icon__box">
                                            <i class="monitor-icon icon"></i>
                                        </div>
                                        <p>iMac</p>
                                    </div>
                                    <!-- <div class="slidebar__item__link__icon__last__wrapper">
                            ...
                            <!-- keyboard mouse -->
                            <li class="slidebar__item">
                                <a href="#macmini" class="slidebar__item__link">
                                    <div class="slidebar__item__link__text__wrapper">
                                        <div class="slidebar__item__link__text__wrapper__icon__box">
                                            <i class="keyboard-icon icon"></i>
                                        </div>
                                        <p>Mac mini</p>
                                    </div>
                                </a>
                            ...
                            <li class="slidebar__item">
                                <a href="#airpods" class="slidebar__item__link">
                                    <div class="slidebar__item__link__text__wrapper">
                                        <div class="slidebar__item__link__text__wrapper__icon__box">
                                            <i class="sound-icon icon"></i>
                                        </div>
                                        <p>AirPods</p>
                                    </div>
                                </a>
                            ...
                            <!-- accessory -->
                            <li class="slidebar__item">
                                <a href="#accessory" class="slidebar__item__link">
                                    <div class="slidebar__item__link__text__wrapper">
                                        <div class="slidebar__item__link__text__wrapper__icon__box">
                                            <i class="accessory-icon icon"></i>
                                        </div>
                                        <p>Phụ kiện</p>
                                    </div>
                                </a>
                        ...
                        <div class="slider__top">
                            ...
                            <a href="/sale">
                                <div class="slider__top__wrapper">
                                    <img src="{{ asset('images/slider/1.webp')}}" alt="image" class="slider__top__item">
                                    <img src="{{ asset('images/slider/2.webp')}}" alt="image" class="slider__top__item">
                                    <img src="{{ asset('images/slider/3.webp')}}" alt="image" class="slider__top__item">
                                </div>
                            </a>
                            <!-- End PC -->
                        </div>
                        <div class="slider__bottom">
                            <div class="slider__bottom__list">
                                ...
                                <div class="slider__bottom__item">
                                    <a href="/sale" class="slider__bottom__item__link">
                                ...
                                <div class="slider__bottom__item">
                                    <a href="/sale" class="slider__bottom__item__link">
                                        <p class="slider__bottom__item__link__text__1st">Give Away</p>
                                        <p class="slider__bottom__item__link__text__2nd">Nhiều phụ kiện hấp dấn</p>
                                    </a>
                                    <div class="slider__bottom__item__underline"></div>
                                </div>
                                <!-- 3rd -->
                                <div class="slider__bottom__item">
                                    <a href="/sale" class="slider__bottom__item__link">
                                        <p class="slider__bottom__item__link__text__1st">Mua trả góp iPhone</p>
                                        <p class="slider__bottom__item__link__text__2nd">Lãi xuất 0%</p>
                                    </a>
                                    <div class="slider__bottom__item__underline"></div>
                                </div>
                                <!-- 4th -->
                                <div class="slider__bottom__item">
                                    <a href="/sale" class="slider__bottom__item__link">
                                        <p class="slider__bottom__item__link__text__1st">MacBook Pro M1</p>
                                        <p class="slider__bottom__item__link__text__2nd">Sắp về hàng</p>
                                    </a>
                                    <div class="slider__bottom__item__underline"></div>
                                </div>
                                <!-- 5th -->
                                <div class="slider__bottom__item">
                                    <a href="/sale" class="slider__bottom__item__link">
                                        <p class="slider__bottom__item__link__text__1st">Mua AirPods</p>
                                        <p class="slider__bottom__item__link__text__2nd">Rút thăm may mắn</p>
                                    </a>
                                    <div class="slider__bottom__item__underline"></div>
                                </div>
                            </div>
                ...
                <div class="c-3">
                    <div class="slide__ads__wrapper tablet__disable">
                        <a href="/sale"><img src="{{ asset('images/slider/r1.webp')}}" alt=""></a>
                    </div>
                    <div class="slide__ads__wrapper tablet__disable">
                        <a href="/sale"><img src="{{ asset('images/slider/r2.webp')}}" alt=""></a>
                    </div>
                    <div class="slide__ads__wrapper tablet__disable">
                        <a href="/sale"><img src="{{ asset('images/slider/r3.webp')}}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="tablet__slider">
            <div class="tablet__slider__wrapper">
                <div class="tablet__slider__item">
                    <img src="{{ asset('images/slider/1.webp')}}" alt="image">
                </div>
                <div class="tablet__slider__item">
                    <img src="{{ asset('images/slider/2.webp')}}" alt="image">
                </div>
                <div class="tablet__slider__item">
                    <img src="{{ asset('images/slider/3.webp')}}" alt="image">
                </div>
            </div>
        ...
        <div class="web__ads gird wide">
            <div class="row">
                <div class="web__ads__box">
                    <a href="/sale">
                        <img src="{{ asset('images/slider/ads.webp')}}" alt="" class="web__ads__box__pc__img">
                    </a>
                    <a href="/sale">
                        <img src="{{ asset('images/slider/tabletAds.webp')}}" alt="" class="web__ads__box__tablet__img">
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <div class="flash__hot__sale">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            <defs>
                                ...
                                <filter id="Path_1420" x="140.854" y="1.116" width="131.369" height="29.655"
                                    filterUnits="userSpaceOnUse">
                                    <feOffset dy="1" input="SourceAlpha"></feOffset>
                                ...
                                <filter id="power" x="0" y="0" width="27.109" height="38.337"
                                    filterUnits="userSpaceOnUse">
                                ...
                                <g id="Group_364" data-name="Group 364" transform="translate(-107 6)">
                                    <g id="Group_185" data-name="Group 185" transform="translate(134 10)">
                                        <g transform="matrix(1, 0, 0, 1, 71.7, 604)" filter="url(#Path_1419)">
                                            <path id="Path_1419-2" data-name="Path 1419"
                                                ...
                                                transform="translate(82.3 28)" fill="#fb4700"></path>
                                        </g>
                    ...
                    <div class="flash__sale__product">
                        ...
                        <div class="flash__sale__product__img__wrapper">
                            <?php
								...
								?>
                            <a href="/product/{{$product->id}}"><img src="{{ $img}}" alt=""></a>
                        </div>
                        <div class="flash__sale__product__desc">
                            <a href="/product/{{$product->id}}" class="flash__sale__product__desc__title">
        ...
        <div id="iPhone" class="menu-session">
        ...
        <div class="featured__phone grid wide">
            ...
            <div class="row featured__phone__gutter">
                ...
                <div class="c-5">
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/0-10" class="futured__phone__item">iPhone X Series</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/0-11" class="futured__phone__item">iPhone 11 Series</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/0-12" class="futured__phone__item">iPhone 12 Series</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/0-13" class="futured__phone__item">iPhone 13 Series</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/0" class="futured__phone__item">Xem tất cả</a>
                    </div>
                </div>
            </div>
            <!-- Tablet -->
            <div class="tablet__featured__phone">
                <div class="tablet__featured__phone__title">
                    <div class="featured__phone__title__text">iPhone mới nhất</div>
                    <a href="/product/type/0">Xem tất cả</a>
                </div>
                <div class="tablet__featured__phone__tag__list">
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/0-10">iPhone X Series</a>
                    </div>
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/0-11">iPhone 11 Series</a>
                    </div>
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/0-12">iPhone 12 Series</a>
                    </div>
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/0-13">iPhone 13 Series</a>
                    </div>
                </div>
            </div>
            <!-- Product List -->
        ...
        <div class="featured__phone grid wide">
            ...
            <div class="row featured__phone__gutter">
                ...
                <div class="c-7  featured__phone__related__tag__list">
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/1-pro" class="futured__phone__item">MacBook Pro</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/1-air" class="futured__phone__item">MacBook Air</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/1" class="futured__phone__item">Xem tất cả</a>
                    </div>
                </div>
            </div>
            <!-- Tablet -->
            <div class="tablet__featured__phone">
                <div class="tablet__featured__phone__title">
                    <div>MacBook mới nhất</div>
                    <a href="/product/type/1">Xem tất cả</a>
                </div>
                <div class="tablet__featured__phone__tag__list">
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/1-pro">MacBook Pro</a>
                    </div>
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/1-air">MacBook Air</a>
                    </div>
            ...
            <div class="featured__phone__product__list">
                ...
                <div class="featured__phone__product__item">
                    ...
                    <div class="featured__phone__product__img__wrapper">
                        <?php
							$string = "/images/product/" . $product->img;
						?>
                        <a href="/product/{{$product->id}}">
                            <img src="{{$string}}" alt="">
                        </a>
        ...
        <!-- End laptop -->
        <div id="ipad" class="menu-session">
        ...
        <div class="featured__phone grid wide">
            ...
            <div class="row featured__phone__gutter">
                ...
                <div class="c-7  featured__phone__related__tag__list">
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/2-pro" class="futured__phone__item">iPad Pro</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/2-air" class="futured__phone__item">iPad Air</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/2-mini" class="futured__phone__item">iPad mini</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/2" class="futured__phone__item">Xem tất cả</a>
                    </div>
                </div>
            </div>
            <!-- Tablet -->
            <div class="tablet__featured__phone">
                <div class="tablet__featured__phone__title">
                    <div>iPad mới nhất</div>
                    <a href="/product/type/2">Xem tất cả</a>
                </div>
                <div class="tablet__featured__phone__tag__list">
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/2-pro">iPad Pro</a>
                    </div>
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/2-air">iPad Air</a>
                    </div>
                </div>
            </div>
            <!-- Product List -->
        ...
        <div id="watch" class="menu-session">
        ...
        <div class="featured__phone grid wide">
            <div class="row featured__phone__gutter">
                ...
                <div class="c-7  featured__phone__related__tag__list">
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/3-7" class="futured__phone__item">Apple Watch Series 7</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/3-3" class="futured__phone__item">Apple Watch Series 3</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/3-se" class="futured__phone__item">Apple Watch SE</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/3" class="futured__phone__item">Xem tất cả</a>
                    </div>
                </div>
            </div>
            <!-- Tablet -->
            <div class="tablet__featured__phone">
                <div class="tablet__featured__phone__title">
                    <a href="/product/type/3">Apple Watch mới nhất</a>
                    <a href="/product/type/3">Xem tất cả</a>
                </div>
                <div class="tablet__featured__phone__tag__list">
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/3-7">Apple Watch Series 7</a>
                    </div>
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/3-3">Apple Watch Series 3</a>
                    </div>
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/3-se">Apple Watch SE</a>
                    </div>
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/3">Xem tất cả</a>
                    </div>
        ...
        <div id="imac" class="menu-session">
        ...
        <div class="featured__phone grid wide">
            ...
            <div class="row featured__phone__gutter">
                ...
                <div class="c-7  featured__phone__related__tag__list">
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/4-24" class="futured__phone__item">iMac 24</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/4-27" class="futured__phone__item">iMac 27</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/4" class="futured__phone__item">Xem tất cả</a>
                    </div>
                </div>
            </div>
            <!-- Tablet -->
            <div class="tablet__featured__phone">
                <div class="tablet__featured__phone__title">
                    <a href="/product/type/4">iMac mới nhất</a>
                    <a href="/product/type/4">Xem tất cả</a>
                </div>
                <div class="tablet__featured__phone__tag__list">
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/4-24">iMac 24</a>
                    </div>
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/4-27">iMac 27</a>
                    </div>
                </div>
            </div>
            <!-- Product List -->
        ...
        <div id="macmini" class="menu-session">
        ...
        <div class="featured__phone grid wide">
            ...
            <div class="row featured__phone__gutter">
                ...
                <div class="c-7  featured__phone__related__tag__list">
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/5-20" class="futured__phone__item">Mac mini 2020</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/5-21" class="futured__phone__item">Mac mini 2021</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/5" class="futured__phone__item">Xem tất cả</a>
                    </div>
                </div>
            </div>
            <!-- Tablet -->
            <div class="tablet__featured__phone">
                <div class="tablet__featured__phone__title">
                    <a href="/product/type/5">Mac mini mới nhất</a>
                    <a href="/product/type/5">Xem tất cả</a>
                </div>
            </div>
            <!-- Product List -->
            <div class="featured__phone__product__list">
        ...
        <div id="airpods" class="menu-session">
        ...
        <div class="featured__phone grid wide">
            ...
            <div class="row featured__phone__gutter">
                ...
                <div class="c-7  featured__phone__related__tag__list">
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/6-2" class="futured__phone__item">AirPods 2</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/6-pro" class="futured__phone__item">AirPods Pro</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/6" class="futured__phone__item">Xem tất cả</a>
                    </div>
                </div>
            </div>
            <!-- Tablet -->
            <div class="tablet__featured__phone">
                <div class="tablet__featured__phone__title">
                    <a href="/product/type/6">iMac mới nhất</a>
                    <a href="/product/type/6">Xem tất cả</a>
                </div>
                <div class="tablet__featured__phone__tag__list">
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/6-24">iMac 24</a>
                    </div>
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/6-27">iMac 27</a>
                    </div>
                </div>
            </div>
            <!-- Product List -->
        ...
        <div id="accessory" class="menu-session">
        ...
        <div class="featured__phone grid wide">
            ...
            <div class="row featured__phone__gutter">
                ...
                <div class="c-7  featured__phone__related__tag__list">
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/7-o" class="futured__phone__item">Ốp lưng</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/7-c" class="futured__phone__item">Cáp sạc</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/7-s" class="futured__phone__item">Củ sạc</a>
                    </div>
                    <div class="featured__phone__related__tag">
                        <a href="/product/type/7" class="futured__phone__item">Xem tất cả</a>
                    </div>
                </div>
            </div>
            <!-- Tablet -->
            <div class="tablet__featured__phone">
                <div class="tablet__featured__phone__title">
                    <a href="/product/type/7">iMac mới nhất</a>
                    <a href="/product/type/7">Xem tất cả</a>
                </div>
                <div class="tablet__featured__phone__tag__list">
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/7">iMac 24</a>
                    </div>
                    <div class="tablet__featured__phone__tag__item">
                        <a href="/product/type/7">iMac 27</a>
                    </div>
                </div>
            </div>
            <!-- Product List -->
        ...
        <div class="featured__phone grid wide">
            ...
            <div class="row featured__phone__gutter">
                <div class="c-3">
                    <div class="featured__phone__title__tech">
                        <a href="/sale" class="featured__phone__title__text">Chuyên trang công nghệ</a>
                    </div>
                </div>
            </div>
            <!-- Tablet -->
            <div class="tablet__featured__phone">
                <div class="tablet__featured__phone__title">
                    <a href="/sale">Chuyên trang thương hiệu</a>
                </div>
            </div>
            <div class="row">
                <div class="brand__wrapper">
                    <a href="/sale"><img src="{{ asset('images/c1.webp')}}" alt="" class="brand__img"></a>
                </div>
                <div class="brand__wrapper">
                    <a href="/sale"><img src="{{ asset('images/c2.webp')}}" alt="" class="brand__img"></a>
                </div>
                <div class="brand__wrapper">
                    <a href="/sale"><img src="{{ asset('images/c3.webp')}}" alt="" class="brand__img"></a>
                </div>
                <div class="brand__wrapper">
                    <a href="/sale"><img src="{{ asset('images/c4.webp')}}" alt="" class="brand__img"></a>
                </div>
            </div>
            <div class="row">
                <div class="tablet__brand__wrapper__column">
                    <div class="tablet__brand__wrapper">
                        <a href="/sale"><img src="{{ asset('images/c1.webp')}}" alt="" class="tablet__brand__img"></a>
                    </div>
                    <div class="tablet__brand__wrapper">
                        <a href="/sale"><img src="{{ asset('images/c2.webp')}}" alt="" class="tablet__brand__img"></a>
                    </div>
                </div>
                <div class="tablet__brand__wrapper__column">
                    <div class="tablet__brand__wrapper">
                        <a href="/sale"><img src="{{ asset('images/c3.webp')}}" alt="" class="tablet__brand__img"></a>
                    </div>
                    <div class="tablet__brand__wrapper">
                        <a href="/sale"><img src="{{ asset('images/c4.webp')}}" alt="" class="tablet__brand__img"></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
    const yearSale = {{$discountTime->year}};
    const monthSale = {{$discountTime->month}} - 1;
    const daySale = {{$discountTime->day}};
    const hourSale = {{$discountTime->hours}};
    const minuteSale = {{$discountTime->minutes}};
    countDownFlashSales(yearSale, monthSale, daySale, hourSale, minuteSale);

    // Count down
    function countDownFlashSales(yearSale, monthSale, daySale, hourSale, minuteSale) {
        let second, minute, hour, day;

        const currentDate = new Date();
        const endDate = new Date(yearSale, monthSale, daySale, hourSale, minuteSale, 59);
    ...
    chatbox.setAttribute("page_id", "102839375566496");
